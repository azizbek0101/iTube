            ...
            <div className="page">
                <div className="page-left">
                    <div className="page__video">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/tKVzm0SBYtQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                </div>
